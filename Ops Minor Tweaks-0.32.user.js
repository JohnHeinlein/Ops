...
$(document).ready(function(){
    debug("ready", "Initializing tweaks script");
    ...
    if(window.location.href.includes("/Process")){
        debug("ready","Running process-page specific extensions...");
...
function setTitle(numTries = 0){
    if(debug){console.log("[tweaks.setTitle] attempt " + numTries)}
...
function charCount(){
    debug("charCount","initializating character counter...");
    ...
    debug("charCount","injected counter");
    ...
    function updateCount(){
        debug("charCount","updating character counter");
        var total = 0;
